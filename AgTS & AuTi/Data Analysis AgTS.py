...
hums=[66.33,55.65,71.5,82.8]
std_hum=[18.26173677,18.56305352,15.94704503,14.11507029]
...
ax1.text(2.75,8,'n =' + str(spots_with_values_greater_than_3_4),fontsize=40)
ax1.set_ylim(-3,30)
...
carbonNum = ['C10','C11','C12','C13','C14','C15','C16','C17']
hums=[93.79,52.64,59.57,67.8,65.05,60.34,78.44,56.34]


plt.scatter(dogs,counter2,c='black',s=80)
plt.xticks(np.arange(10, 17 + 1, 1),['C10','C11','C12','C13','C14','C15','C16','C17'],fontsize = 15)
...
plt.text(1.8,2,'n =' + str(spots_with_values_greater_than_3_2),fontsize=40)
plt.text(2.8,9,'n =' + str(spots_with_values_greater_than_3_3),fontsize=40)
...
#print(avg)
'''
#hums=[83.92,66.33,55.65,71.5]  #include 10pm-10am
#hums=[86.15,66.33,55.65,71.5]  #include 6am-10pm exclude 10pm-10am
hums=[66.33,55.65,71.5,82.8] 
...
ax2.set_ylabel('Humidity(%)', color='blue',fontsize=40)
ax2.tick_params(axis='y', labelcolor='blue',labelsize=40)
ax1.text(-0.2,7,'n =' + str(total_spots_time[0]),fontsize=40)
ax1.text(0.8,4,'n =' + str(total_spots_time[1]),fontsize=40)
ax1.text(1.8,2,'n =' + str(total_spots_time[2]),fontsize=40)
ax1.text(2.8,8,'n =' + str(total_spots_time[3]),fontsize=40)
ax1.set_ylim(-3,50)
for x in range(len(timePeriod)):
    if not(std_time[x] == -1):
        ax1.errorbar(label[x], counter2tot[x],yerr=std_time[x],fmt='none',capsize=20,ecolor='red')
