# -*- coding: utf-8 -*-
"""
Created on Sat Jan  6 00:01:49 2024
...
fc='fc'
c=chr(92)
carbo_folder_path= r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\New dataset AuTi'
...
with pd.ExcelWriter(r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\Captured Data\Au_2.xlsx', engine='xlsxwriter') as writer:
...
with pd.ExcelWriter(r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\Captured Data\Au__std_2.xlsx', engine='xlsxwriter') as writer:
