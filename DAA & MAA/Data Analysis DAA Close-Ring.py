...
fc='fc'
c=chr(92)
carbo_folder_path= r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\DAA Close-Ring'
...
hums=[78.05625,73.93208333,78.24,88.42916667]
label = ['Noon','Afternoon','Evening','Night']
std_hum = [9.553931482,10.93894609,11.52123583,7.170744625]
std_time[1] = 2.98
...
hums=[72.739,63.104,86.538,70.62,95.674,90.885]


plt.scatter(dogs,counter2,c='black',s=80)
plt.xticks(np.arange(0, 5 + 1, 1),carbonNum,fontsize = 15)
...
plt.text(0.8,40,'n = 6',fontsize=40)
for x in range(len(timePeriod)):
