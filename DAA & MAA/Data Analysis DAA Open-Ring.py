...
fc='fc'
c=chr(92)
carbo_folder_path= r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\DAA Open Ring'
...
hums=[70.986875,65.8525,73.640625,85.92]
label = ['Noon','Afternoon','Evening','Night']
std_hum = [14.8704433,10.74842459,9.673418778,9.564766398]
...
hums=[55.019,59.949,80.374,74.0135]


plt.scatter(dogs,counter2,c='black',s=80)
plt.xticks(np.arange(0, 3 + 1, 1),carbonNum,fontsize = 15)
