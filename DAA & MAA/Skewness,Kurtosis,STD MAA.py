        ...
        if not any(value > 0 for value in Abso):
            ...
            for numpos, numneg in zip(newpos,newneg):
                ...
                if(numpos == 0.5):
                    ...
                    if( int(values) >= 12 and int(values) <= 13):
...
skew_carbon_p1_neg = [0] * 2
kur_carbon_p1_neg = [0] * 2
std_carbon_p1_neg = [0] * 2

skew_carbon_p5_neg = [0] * 2
kur_carbon_p5_neg = [0] * 2
std_carbon_p5_neg = [0] * 2
...
skew_carbon_p1_normalize = [0] * 2
kur_carbon_p1_normalize = [0] * 2
std_carbon_p1_normalize = [0] * 2

skew_carbon_p5_normalize = [0] * 2
kur_carbon_p5_normalize = [0] * 2
std_carbon_p5_normalize = [0] * 2

skew_carbon_p1_neg_normalize = [0] * 2
kur_carbon_p1_neg_normalize = [0] * 2
std_carbon_p1_neg_normalize = [0] * 2

skew_carbon_p5_neg_normalize = [0] * 2
kur_carbon_p5_neg_normalize = [0] * 2
std_carbon_p5_neg_normalize = [0] * 2
...
carbon_length = ['C12NHMe 3h','C12NHMe RT']
