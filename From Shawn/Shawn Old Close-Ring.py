...
fc='fc'
c=chr(92)
carbo_folder_path= r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\Rearranged Shawn Old'
#carbonLen = [9,11,13,15]
dogs=np.linspace(10,14,5)
...
shortcounter=0
devcount=0
devs=np.linspace(0,4,5)
counter2=np.linspace(0,4,5)
stdavg=np.linspace(0,4,5)
scounts=np.linspace(0,4,5)
shorting=np.linspace(0,4,5)
...
hums=[71.896375,68.301,74.51825,80.4943125]
label = ['Noon','Afternoon','Evening','Night']
std_hum = [17.76923403,20.7289136,13.77049879,11.82496991]
...
ax1.text(0.75,-2,'n = 17',fontsize=40)
ax1.text(1.75,-2,'n =' + str(spots_with_values_greater_than_3_3),fontsize=40)
ax1.text(2.75,25,'n =' + str(spots_with_values_greater_than_3_4),fontsize=40)
ax1.set_ylim(-3,50)
...
carbonNum = ['C10CNC4','C10CNC5','C11CNC4','C11CNC5_P2','C11CNC5_P2']
...
plt.text(2.8,0,'n =' + str(spots_with_values_greater_than_3_3),fontsize=40)
#plt.text(0.3,10,'No Measurement Taken in Autumn and Winter',fontsize=40,color='red')
