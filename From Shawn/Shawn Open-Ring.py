...
fc='fc'
c=chr(92)
carbo_folder_path= r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\Rearranged Shawn Paper data'
#carbonLen = [9,11,13,15]
dogs=np.linspace(10,13,4)
...
hums=[83.9105,80.511,90.5,91.3995]
label = ['Noon','Afternoon','Evening','Night']
std_hum = [11.67454259,13.62461152,4.216378778,4.096304402]
...
carbonNum = ['C10CNC2','C10CNC3','C11CNC2','C11CNC3']
