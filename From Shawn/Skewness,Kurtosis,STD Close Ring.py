...
fc='fc'
c=chr(92)
carbo_folder_path= r'E:\SMMT Group\Rearranged Shawn Old'
...
shortcounter=0
devcount=0
devs=np.linspace(10,14,5)
counter2=np.linspace(10,14,5)
stdavg=np.linspace(10,14,5)
scounts=np.linspace(10,14,5)
shorting=np.linspace(10,14,5)
#Very basic idea
#positive
p5_total = []
p45_total = []
...
skew_carbon_p1_neg = [0] * 5
kur_carbon_p1_neg = [0] * 5
std_carbon_p1_neg = [0] * 5

skew_carbon_p5_neg = [0] * 5
kur_carbon_p5_neg = [0] * 5
std_carbon_p5_neg = [0] * 5
...
skew_carbon_p1_normalize = [0] * 5
kur_carbon_p1_normalize = [0] * 5
std_carbon_p1_normalize = [0] * 5

skew_carbon_p5_normalize = [0] * 5
kur_carbon_p5_normalize = [0] * 5
std_carbon_p5_normalize = [0] * 5

skew_carbon_p1_neg_normalize = [0] * 5
kur_carbon_p1_neg_normalize = [0] * 5
std_carbon_p1_neg_normalize = [0] * 5

skew_carbon_p5_neg_normalize = [0] * 5
kur_carbon_p5_neg_normalize = [0] * 5
std_carbon_p5_neg_normalize = [0] * 5
