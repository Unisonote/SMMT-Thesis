...
fc='fc'
c=chr(92)
carbo_folder_path= r'E:\SMMT Group\Rearranged Shawn Paper data'
...
shortcounter=0
devcount=0
devs=np.linspace(10,13,4)
counter2=np.linspace(10,13,4)
stdavg=np.linspace(10,13,4)
scounts=np.linspace(10,13,4)
shorting=np.linspace(10,13,4)
#Very basic idea
#positive
p5_total = []
p45_total = []
...
skew_carbon_p1_neg = [0] * 4
kur_carbon_p1_neg = [0] * 4
std_carbon_p1_neg = [0] * 4

skew_carbon_p5_neg = [0] * 4
kur_carbon_p5_neg = [0] * 4
std_carbon_p5_neg = [0] * 4
...
skew_carbon_p1_normalize = [0] * 4
kur_carbon_p1_normalize = [0] * 4
std_carbon_p1_normalize = [0] * 4

skew_carbon_p5_normalize = [0] * 4
kur_carbon_p5_normalize = [0] * 4
std_carbon_p5_normalize = [0] * 4

skew_carbon_p1_neg_normalize = [0] * 4
kur_carbon_p1_neg_normalize = [0] * 4
std_carbon_p1_neg_normalize = [0] * 4

skew_carbon_p5_neg_normalize = [0] * 4
kur_carbon_p5_neg_normalize = [0] * 4
std_carbon_p5_neg_normalize = [0] * 4
