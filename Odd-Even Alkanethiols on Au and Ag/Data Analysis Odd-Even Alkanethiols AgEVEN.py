...
fc='fc'
c=chr(92)
carbo_folder_path= r'F:\Thuo Research Group\RE Martin data\EVEN odd-even alkanethiols on Ag'
#carbonLen = [9,11,13,15]
dogs=np.linspace(9,12,4)
dogs_ign = np.linspace(9,10,2)
...
devcount=0
z = 0
devs=np.linspace(0,3,4)
counter2=np.linspace(0,3,4)
stdavg=np.linspace(0,3,4)
scounts=np.linspace(0,3,4)
shorting=np.linspace(0,3,4)
J_01 = [[] for i in range(2)]
J_01_neg = [[] for i in range(2)]
J_05 = [[] for i in range(2)]
J_05_neg = [[] for i in range(2)]
counter2tot = [0] * 5
    ...
    for n in range(len(unique_numbers)):
        ...
        if not any(value > 0 for value in Abso):
            for numpos, numneg in zip(newpos,newneg):
                ...
                k+=1
                if (int(values) != 11) and (int(values) != 12):                  
                        if(numpos == 0.5):
        ...
        try:            
           J_01[i] = round(sum(J_01_temp) / len(J_01_temp),4)
           J_01_neg[i] = round(sum(J_01_neg_temp) / len(J_01_neg_temp),4)
           J_05[i] = round(sum(J_05_temp) / len(J_05_temp),4)
           J_05_neg[i] = round(sum(J_05_neg_temp) / len(J_05_neg_temp),4)
...
carbonNum = ['C8','C14','C16','C18']
hums=[23.77, 79.71375, 84.9475, 76.43667]


plt.scatter(dogs,counter2,c='black',s=80)
plt.xticks(np.arange(9, 12 + 1, 1),['C8','C14','C16','C18'],fontsize = 15)
...
plt.xticks(np.arange(9, 10 + 1, 1),['C8','C14'],fontsize = 15)
plt.yticks(np.arange(0,max(J_01), 0.1),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
...
plt.xlabel('Carbon Length')
plt.ylabel('Log J')
plt.text(9,-4.5,J_01[0],fontsize=12)
plt.text(10,-4.5,J_01[1],fontsize=12)
plt.show()

plt.scatter(dogs_ign,J_01_neg,color='black',s=80)
plt.xticks(np.arange(9, 10 + 1, 1),['C8','C14'],fontsize = 15)
plt.yticks(np.arange(0,max(J_01_neg), 0.1),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('Current Density at -0.1V',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Log J')
plt.text(9,-4.5,J_01_neg[0],fontsize=12)
plt.text(10,-4.5,J_01_neg[1],fontsize=12)
plt.show()

plt.scatter(dogs_ign,J_05,color='black',s=80)
plt.xticks(np.arange(9, 10 + 1, 1),['C8','C14'],fontsize = 15)
plt.yticks(np.arange(0,max(J_05), 0.1),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
...
plt.xlabel('Carbon Length')
plt.ylabel('Log J')
plt.text(9,-3,J_05[0],fontsize=12)
plt.text(10,-3,J_05[1],fontsize=12)
plt.show()

plt.scatter(dogs_ign,J_05_neg,color='black',s=80)
plt.xticks(np.arange(9, 10 + 1, 1),['C8','C14'],fontsize = 15)
plt.yticks(np.arange(0,max(J_05_neg), 0.1),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('Current Density at -0.5V',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Log J')
plt.text(9,-3,J_05_neg[0],fontsize=12)
plt.text(10,-3,J_05_neg[1],fontsize=12)
plt.show()
