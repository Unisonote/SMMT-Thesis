...
fc='fc'
c=chr(92)
carbo_folder_path= r'F:\Thuo Research Group\RE Martin data\ODD Odd-even alkanethiols on AgM'
...
plt.xticks(np.arange(7, 12 + 1, 1),['C7','C9','C11','C13','C17','C19'],fontsize = 15)
plt.yticks(np.arange(0,max(J_025), 0.0001),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
...
plt.text(7,0.00015,J_025[0],fontsize=12)
plt.text(8,0.0004,J_025[1],fontsize=12)
plt.text(9,0.00035,J_025[2],fontsize=12)
plt.text(10,0.00025,J_025[3],fontsize=12)
plt.text(11,0.0001,J_025[4],fontsize=12)
plt.text(12,0.00015,J_025[5],fontsize=12)
plt.show()

plt.scatter(dogs,J_025_neg,color='black',s=80)
plt.xticks(np.arange(7, 12 + 1, 1),['C7','C9','C11','C13','C17','C19'],fontsize = 15)
plt.yticks(np.arange(0,max(J_025_neg), 0.0001),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('J at -0.25V Vs Number of Shorted Junctions',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Current Density')
plt.text(7,0.00001,J_025_neg[0],fontsize=12)
plt.text(8,0.00015,J_025_neg[1],fontsize=12)
plt.text(9,0.00019,J_025_neg[2],fontsize=12)
plt.text(10,0.00025,J_025_neg[3],fontsize=12)
plt.text(11,0.000015,J_025_neg[4],fontsize=12)
plt.text(12,0,J_025_neg[5],fontsize=12)
plt.show()

plt.scatter(dogs,J_05,color='black',s=80)
plt.xticks(np.arange(7, 12 + 1, 1),['C7','C9','C11','C13','C17','C19'],fontsize = 15)
plt.yticks(np.arange(0,max(J_05), 0.0005),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
...
plt.xlabel('Carbon Length')
plt.ylabel('Current Density')
plt.text(7,0.0006,J_05[0],fontsize=12)
plt.text(8,0.003,J_05[1],fontsize=12)
plt.text(9,0.00125,J_05[2],fontsize=12)
plt.text(10,0.002,J_05[3],fontsize=12)
plt.text(11,0.0002,J_05[4],fontsize=12)
plt.text(12,0.0005,J_05[5],fontsize=12)
plt.show()

plt.scatter(dogs,J_05_neg,color='black',s=80)
plt.xticks(np.arange(7, 12 + 1, 1),['C7','C9','C11','C13','C17','C19'],fontsize = 15)
plt.yticks(np.arange(0,max(J_05_neg), 0.0005),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('J at -0.5V Vs Number of Shorted Junctions',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Current Density')
plt.text(7,0.0004,J_05_neg[0],fontsize=12)
plt.text(8,0.0015,J_05_neg[1],fontsize=12)
plt.text(9,0.00075,J_05_neg[2],fontsize=12)
plt.text(10,0.0016,J_05_neg[3],fontsize=12)
plt.text(11,0.00015,J_05_neg[4],fontsize=12)
plt.text(12,0.00013,J_05_neg[5],fontsize=12)
plt.show()
