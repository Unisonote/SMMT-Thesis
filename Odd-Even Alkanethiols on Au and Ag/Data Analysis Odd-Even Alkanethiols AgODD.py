...
fc='fc'
c=chr(92)
carbo_folder_path= r'F:\Thuo Research Group\RE Martin data\ODD Odd-even alkanethiols on Ag'
#carbonLen = [9,11,13,15]
dogs=np.linspace(7,13,7)
dogs_ign = np.linspace(8,12,5)
...
shortcounter=0
devcount=0
devs=np.linspace(0,6,7)
counter2=np.linspace(0,6,7)
stdavg=np.linspace(0,6,7)
scounts=np.linspace(0,6,7)
shorting=np.linspace(0,6,7)
J_01 = [[] for i in range(5)]
J_01_neg = [[] for i in range(5)]
J_05 = [[] for i in range(5)]
J_05_neg = [[] for i in range(5)]
counter2tot = [0] * 5
    ...
    for n in range(len(unique_numbers)):
        ...
        if not any(value > 0 for value in Abso):
            for numpos, numneg in zip(newpos,newneg):
                ...
                k+=1
                if (int(values) != 7) and (int(values) != 12):                  
                        if(numpos == 0.5):
                            if not any(value > std for value in nl1std) or not any(value > std for value in nl2std):
                                J_05_temp = new_list1
                        if(numneg == -0.5):
                            if not any(value > std for value in nl1std) or not any(value > std for value in nl2std):
                                J_05_neg_temp = new_list2
                        if(numpos == 0.1):
                            if not any(value > std for value in nl1std) or not any(value > std for value in nl2std):
                                J_01_temp = new_list1          
                        if(numneg == -0.1):
                            if not any(value > std for value in nl1std) or not any(value > std for value in nl2std):
                                J_01_neg_temp = new_list2
                #print(nl1std,nl2std)
        ...
        try:
            if (int(values) != 7) and (int(values) != 12.0):
                J_01[z] = round(sum(J_01_temp) / len(J_01_temp),4)
                J_01_neg[z] = round(sum(J_01_neg_temp) / len(J_01_neg_temp),4)
                J_05[z] = round(sum(J_05_temp) / len(J_05_temp),4)
                J_05_neg[z] = round(sum(J_05_neg_temp) / len(J_05_neg_temp),4)
...
scounts[3] = 17
carbonNum = ['C7','C9','C11','C13','C15','C17','C19']
hums=[26.18, 67.3133, 59.82857, 42.57583,49.25286,95.57,61.216]
...
plt.scatter(dogs_ign,J_01,color='black',s=80)
plt.xticks(np.arange(8, 12 + 1, 1),['C9','C11','C13','C15','C17'],fontsize = 15)
plt.yticks(np.arange(min(J_01),0, 1),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('Current Density at 0.1V',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Log J')
plt.text(8,-3,J_01[0],fontsize=12)
plt.text(9,-3,J_01[1],fontsize=12)
plt.text(10,-3,J_01[2],fontsize=12)
plt.text(11,-6,J_01[3],fontsize=12)
plt.text(12,-4,J_01[4],fontsize=12)
plt.show()

plt.scatter(dogs_ign,J_01_neg,color='black',s=80)
plt.xticks(np.arange(8, 12 + 1, 1),['C9','C11','C13','C15','C17'],fontsize = 15)
plt.yticks(np.arange(min(J_01_neg),0, 1),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('Current Density at -0.1V',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Log J')
plt.text(8,-3.5,J_01_neg[0],fontsize=12)
plt.text(9,-3.5,J_01_neg[1],fontsize=12)
plt.text(10,-3.5,J_01_neg[2],fontsize=12)
plt.text(11,-6,J_01_neg[3],fontsize=12)
plt.text(12,-4.8,J_01_neg[4],fontsize=12)
plt.show()

plt.scatter(dogs_ign,J_05,color='black',s=80)
plt.xticks(np.arange(8, 12 + 1, 1),['C9','C11','C13','C15','C17'],fontsize = 15)
plt.yticks(np.arange(min(J_05),0, 1),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('Current Density at 0.5V',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Log J')
plt.text(8,-2,J_05[0],fontsize=12)
plt.text(9,-2,J_05[1],fontsize=12)
plt.text(10,-2,J_05[2],fontsize=12)
plt.text(11,-5,J_05[3],fontsize=12)
plt.text(12,-4,J_05[4],fontsize=12)
plt.show()

plt.scatter(dogs_ign,J_05_neg,color='black',s=80)
plt.xticks(np.arange(8, 12 + 1, 1),['C9','C11','C13','C15','C17'],fontsize = 15)
plt.yticks(np.arange(min(J_05_neg),0, 1),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('Current Density at -0.5V',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Log J')
plt.text(8,-2,J_05_neg[0],fontsize=12)
plt.text(9,-2,J_05_neg[1],fontsize=12)
plt.text(10,-2,J_05_neg[2],fontsize=12)
plt.text(11,-5,J_05_neg[3],fontsize=12)
plt.text(12,-3.8,J_05_neg[4],fontsize=12)
plt.show()
