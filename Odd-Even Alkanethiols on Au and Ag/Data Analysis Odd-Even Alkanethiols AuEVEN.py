...
fc='fc'
c=chr(92)
carbo_folder_path= r'F:\Thuo Research Group\RE Martin data\EVEN odd-even alkanethiols on Au'
...
carbonNum = ['C10','C12','C14','C16']
hums=[94.76, 87.74, 86.26167, 77.777]


plt.scatter(dogs,counter2,c='black',s=80)
plt.xticks(np.arange(9, 12 + 1, 1),['C10','C12','C14','C16'],fontsize = 15)
