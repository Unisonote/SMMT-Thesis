# -*- coding: utf-8 -*-
"""
Created on Thu Sep 21 04:23:41 2023
...
fc='fc'
c=chr(92)
carbo_folder_path= r'F:\Thuo Research Group\RE Martin data\ODD odd-even alkanethiols on Au'
...
J_025 = [[] for i in range(4)]
J_025_neg = [[] for i in range(4)]
J_05 = [[] for i in range(4)]
J_05_neg = [[] for i in range(4)]
'''
J_025 = [0] * 4
J_025_neg = [0] * 4
J_05 = [0] * 4
    ...
    for n in range(len(unique_numbers)):
        ...
        for x in (range(len(Full))):
            if(Full['Voltage (V)'][x] == 0.25):
                if not(Abso[x] > 1):
                    J_025[i].append(Abso[x])            
            elif(Full['Voltage (V)'][x] == -0.25):
                if not(Abso[x] > 1):
                    J_025_neg[i].append(Abso[x])
            elif(Full['Voltage (V)'][x] == 0.5):
                if not(Abso[x] > 1):
                    J_05[i].append(Abso[x])
            elif(Full['Voltage (V)'][x] == -0.5):
                if not(Abso[x] > 1):
                    J_05_neg[i].append(Abso[x])
        '''
        for x in (range(len(Full))):
            if(Full['Voltage (V)'][x] == 0.25):
                if not(Abso[x] > 1):
...
carbonNum = ['C9','C11','C13','C15']
hums=[60.68, 61.0925, 30.925, 54.3375]


plt.scatter(dogs,counter2,c='black',s=80)
plt.xticks(np.arange(9, 12 + 1, 1),['C9','C11','C13','C15'],fontsize = 15)
...
plt.xticks(np.arange(9, 12 + 1, 1),['C9','C11','C13','C15'],fontsize = 15)
plt.yticks(np.arange(0,max(J_025), 0.001),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
...
plt.text(9,0.0012,J_025[0],fontsize=12)
plt.text(10,0.0005,J_025[1],fontsize=12)
plt.text(11,0.00025,J_025[2],fontsize=12)
plt.text(12,0.0005,J_025[3],fontsize=12)
plt.show()

plt.scatter(dogs,J_025_neg,color='black',s=80)
plt.xticks(np.arange(9, 12 + 1, 1),['C9','C11','C13','C15'],fontsize = 15)
plt.yticks(np.arange(0,max(J_025_neg), 0.001),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('J at -0.25V Vs Number of Shorted Junctions',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Current Density')
plt.text(9,0.0011,J_025_neg[0],fontsize=12)
plt.text(10,0.0005,J_025_neg[1],fontsize=12)
plt.text(11,0.00025,J_025_neg[2],fontsize=12)
plt.text(12,0.0005,J_025_neg[3],fontsize=12)
plt.show()

plt.scatter(dogs,J_05,color='black',s=80)
plt.xticks(np.arange(9, 12 + 1, 1),['C9','C11','C13','C15'],fontsize = 15)
plt.yticks(np.arange(0,max(J_05), 0.0025),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
...
plt.xlabel('Carbon Length')
plt.ylabel('Current Density')
plt.text(9,0.0012,J_05[0],fontsize=12)
plt.text(10,0.0005,J_05[1],fontsize=12)
plt.text(11,-0.0001,J_05[2],fontsize=12)
plt.text(12,0.0005,J_05[3],fontsize=12)
plt.show()

plt.scatter(dogs,J_05_neg,color='black',s=80)
plt.xticks(np.arange(9, 12 + 1, 1),['C9','C11','C13','C15'],fontsize = 15)
plt.yticks(np.arange(0,max(J_05_neg), 0.0025),fontsize = 15)
plt.grid(True,alpha=0.25)
#plt.title('Carbon Number Vs Number of Shorted Junctions')
#plt.xlabel('Carbon Length')
plt.title('J at -0.5V Vs Number of Shorted Junctions',fontweight='bold', fontsize=16)
plt.xlabel('Carbon Length')
plt.ylabel('Current Density')
plt.text(9,0.0012,J_05_neg[0],fontsize=12)
plt.text(10,0.0005,J_05_neg[1],fontsize=12)
plt.text(11,0.00025,J_05_neg[2],fontsize=12)
plt.text(12,0.0005,J_05_neg[3],fontsize=12)
plt.show()
