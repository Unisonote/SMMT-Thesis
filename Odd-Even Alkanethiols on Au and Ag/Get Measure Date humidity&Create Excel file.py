...
#API KEY 1: 4QR8RN8KUNUJ84Q8VUS45EUG3
#API KEY 2: 92Y6HB3EP65FKSJJUJR7D7LW7

# This is the core of our weather query URL
BaseURL = 'https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/'

ApiKey='4QR8RN8KUNUJ84Q8VUS45EUG3'
        ...
        for Col in Row:
            if ColIndex >= 4:
                if(FirstRow[ColIndex] == 'humidity'):
                    df = df.append({'Time':Row[1][11:], 'Humidity':Row[ColIndex]}, ignore_index=True )
                    break
            ColIndex += 1
    RowIndex += 1

df.to_csv('E:\SMMT Group\Weather CSV\Shawn Data in Paper\C10CNC2\\' + StartDate + '.csv')
