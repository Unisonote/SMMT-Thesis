...
with pd.ExcelWriter(r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\Captured Data\Ag_1.xlsx', engine='xlsxwriter') as writer:
...
with pd.ExcelWriter(r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\Captured Data\Ag__std_1.xlsx', engine='xlsxwriter') as writer:
