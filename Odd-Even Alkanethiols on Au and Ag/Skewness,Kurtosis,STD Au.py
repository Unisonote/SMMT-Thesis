...
fc='fc'
c=chr(92)
carbo_folder_path= r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\RE Martin data\odd-even alkanethiols on Au'
...
with pd.ExcelWriter(r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\Captured Data\Au_1.xlsx', engine='xlsxwriter') as writer:
...
with pd.ExcelWriter(r'Q:\Shared drives\MSE-Thuo Group\Group Server ISU\Zizhi\Data\Data Analysis\Captured Data\Au__std_1.xlsx', engine='xlsxwriter') as writer:
